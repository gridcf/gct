...
/**
 * @brief Call Context Pre Close
 * @ingroup globus_net_manager_context
 * @details
 * Call the chain of pre_close() functions in a context with the given
 ...
 *     returns an error, the pre_close() calls stop and the error is returned
 *     to the caller.
 */
globus_result_t
